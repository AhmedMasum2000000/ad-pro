...
export const company = {
  ...
  phone: '+880 1958-503753',
  phoneHref: '+8801958503753',
  corporateAddress:
...
export const faqs: Faq[] = [
  {
    ...
    a: 'A digital site is priced per minute of screen time, so what you pay depends on the location, the screen size, how many minutes a day you take and how long the campaign runs. Rates move with demand and season, which is why we quote rather than publish them — call +880 1958-503753 or send the cities and dates and you will have a written price, production and mounting included, within one working day.',
  },
  {
